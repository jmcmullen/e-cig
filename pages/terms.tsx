        ...
        <div>
          ...
          <ol>
            <ol className="list-decimal list-inside">
              <li className="text-2xl mb-3">Acceptance of the Terms of Use </li>
              <p className="mb-3">
                These terms of use are entered into by and between you and
                E-cig.delivery. (“Company”, “we” or “us”). The following terms
                and conditions (these “Terms of Use”), govern your access to and
                use of ‘www.e-cig.delivery’, including any content,
                functionality and services offered on or through
                ‘www.e-cig.delivery’ (the “Website”).
              </p>
              <p className="mb-3">
                ...
                <strong>
                  ...
                  www.e-cig.delivery/privacy, incorporated herein by reference.
                </strong>{' '}
                If you do not want to agree to these Terms of Use or the Privacy
                Policy, you must not access or use the Website.
              </p>
              <p className="mb-3">
                This Website is offered and available to users who are at least
                18 years of age. By using this Website, you represent and
              ...
              <li className="text-2xl mb-3">Changes to the Terms of Use</li>
              <p className="mb-3">
                We may revise and update these Terms of Use from time to time in
                our sole discretion without notice or obligation. All changes
                are effective immediately when we post them, and apply to all
                access to and use of the Website thereafter. Your continued use
                of the Website following the posting of revised Terms of Use
                means that you acknowledge and accept the changes.
              </p>
              <li className="text-2xl mb-3">Use of Products</li>
              <p className="mb-3">
                The products offered on this Website are for research purposes
                only and are not intended for use by any persons. The products
                offered on this website are not to be obtained by anyone under
                the legal age of 18 years.
              </p>
              <p className="mb-3">
                Our products do not treat, diagnose, or cure any disease,
                physical ailment, or condition. Keep out of the reach of
                children and pets as ingestion of certain pieces can present a
                choking hazard.
              </p>
              ...
              <p className="mb-3">
                ...
                discretion without notice. We may update the content on this
                Website from time to time, but its content is not necessarily
                complete or up-to-date. We will not be liable if for any reason
              ...
              <p className="mt-3 mb-3">You are responsible for:</p>
              <ol className="list-disc list-inside">
                ...
                <p className="mt-3 mb-3">
                  ...
                  <em> Privacy Policy</em>, and you consent to all actions we
                  take with respect to your information consistent with our
                  Privacy Policy.
                </p>
              </ol>
              <p className="mt-3 mb-3">
                You agree that: E-cig.delivery, at its sole discretion and
                without prior notice, may terminate your access to or use of the
                Website, at any time and for any reason, including a
                determination that you have violated or acted inconsistently
                with the letter or spirit of these Terms of Use; E-cig.delivery
                shall not be liable to you or any third party for any
                termination of your access to the Website; and those sections in
                these Terms of Use relating to limitation of liability,
                disclaimers, governing law, disputes, indemnification, notice
                and admissibility in a judicial or administrative proceeding
                shall survive any expiration or termination of these Terms of
                Use.
              </p>
              <li className="text-2xl mb-3">Intellectual Property Rights</li>
              <p className="mb-3">
              ...
              <p className="mt-3 mb-3">You must not:</p>
              ...
              <li className="text-2xl mb-3">Prohibited Uses of Website</li>
              <p className="mb-3">
              ...
              <ol className="list-disc list-inside">
                ...
                <li className="mb-1">
                  ...
                  set out below in these Terms of Use.
                </li>
                <li className="mb-1">
                ...
                <p className="mt-3 mb-3">Additionally, you agree not to:</p>
                <li className="mb-1">
                ...
                <li className="mb-1">
                  ...
                  on the Website or for any other unauthorised purpose without
              ...
              <li className="text-2xl mt-3 mb-3">User Contributions</li>
              <ol>
                <p className="mb-3">
                  ...
                  that allow users to post, submit, publish, display or transmit
                  to other users or other persons (hereinafter, “post”) content
                ...
                <p className="mb-3">
                  ...
                  third parties any such material for any purpose and without
                  compensation.
                </p>
              ...
              <li className="text-2xl list-decimal mb-3">
                Monitoring and Enforcement; Termination
              </li>
              <p className="mb-3">We have the right to:</p>
              <ol className="list-disc list-inside mb-3">
                <li>
                ...
                <li>
                  ...
                  Company. Disclose your identity or other information about you
                ...
                <li>
                  ...
                  referral to law enforcement, for any illegal or unauthorised
                  use of the Website.
                </li>
                <li>
              ...
              <p className="mb-3">
                ...
                TAKEN AS A CONSEQUENCE OF INVESTIGATIONS BY EITHER SUCH PARTY OR
              ...
              <li className="text-2xl mb-3">Content Standards</li>
              <p className="mb-3">
              ...
              <li className="text-2xl mb-3">Reliance on Information Posted</li>
              ...
              <p className="mb-3">
                ...
                information presented on or through the Website is made
                available solely for general information purposes with no
                inherent warranties implied. Any reliance you place on such
              ...
              <li className="text-2xl mb-3">Product Pricing</li>

              <p className="mb-3">
                Except where noted otherwise, the prices displayed for products
                represent the full retail price listed on the product itself. We
                cannot confirm the price of an item until you complete an online
                order form.{' '}
              </p>
              ...
              <li className="text-2xl mb-3">Links from the Website</li>
              <p className="mb-3">
              ...
              <li className="text-2xl mb-3">Entire Agreement</li>
              <p className="mb-3">
                The Terms of Use, our Privacy Policy and the Terms of Sale
                constitute the sole and entire agreement between you and
                E-cig.delivery with respect to the Website and supersede all
              ...
              <li className="text-2xl mb-3">Your Comments and Concerns</li>
              <p className="mb-10">
