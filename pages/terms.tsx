  ...
  return (
    <Container>
      <div className="mx-6 my-24">
        <div>
          <h2 className="text-center text-4xl mb-20">Terms and Conditions</h2>
          <h3 className="mb-3 text-3xl">Terms of Use</h3>
          <ol className="list-decimal">
            ...
            <p className="mb-3">
              ...
              E-cig.delivery. (“Company”, “we” or “us”). The following terms and
              conditions (these “Terms of Use”), govern your access to and use
              of ‘www.e-cig.delivery’, including any content, functionality and
              services offered on or through ‘www.e-cig.delivery’ (the
              “Website”).
            </p>
            <p className="mb-3">
            ...
            <p className="mb-3">
              This Website is offered and available to users who are at least 18
              years of age. By using this Website, you represent and warrant
            ...
            <li className="text-2xl mb-3 mt-10">Changes to the Terms of Use</li>
            <p className="mb-3">
              We may revise and update these Terms of Use from time to time in
              our sole discretion without notice or obligation. All changes are
              effective immediately when we post them, and apply to all access
              to and use of the Website thereafter. Your continued use of the
              Website following the posting of revised Terms of Use means that
              you acknowledge and accept the changes.
            </p>
            <li className="text-2xl mb-3 mt-10">Use of Products</li>
            <p className="mb-3">
              ...
              offered on this website are not to be obtained by anyone under the
              legal age of 18 years.
            </p>
            <p className="mb-3">
              Our products do not treat, diagnose, or cure any disease, physical
              ailment, or condition. Keep out of the reach of children and pets
              as ingestion of certain pieces can present a choking hazard.
            </p>
            ...
            <ol className="list-disc list-inside">
              ...
              <p className="mt-3 mb-3">
                ...
                <em> Privacy Policy</em>, and you consent to all actions we take
                with respect to your information consistent with our Privacy
                Policy.
              </p>
            </ol>
            <p className="mt-3 mb-3">
              You agree that: E-cig.delivery, at its sole discretion and without
              prior notice, may terminate your access to or use of the Website,
              at any time and for any reason, including a determination that you
              have violated or acted inconsistently with the letter or spirit of
              these Terms of Use; E-cig.delivery shall not be liable to you or
              any third party for any termination of your access to the Website;
              and those sections in these Terms of Use relating to limitation of
              liability, disclaimers, governing law, disputes, indemnification,
              notice and admissibility in a judicial or administrative
              proceeding shall survive any expiration or termination of these
              Terms of Use.
            </p>
            <li className="text-2xl mb-3 mt-10">
            ...
            <li className="text-2xl mb-3 mt-10">Prohibited Uses of Website</li>
            <p className="mb-3">
            ...
            <ol className="list-disc list-inside">
              ...
              <li className="mb-1">
                ...
                the Website or for any other unauthorised purpose without our
            ...
            <li className="text-2xl mt-3 mb-3 mt-10">User Contributions</li>
            <ol>
              <p className="mb-3">
            ...
            <ol className="list-disc list-inside mb-3">
              ...
              <li>
                ...
                referral to law enforcement, for any illegal or unauthorised use
                of the Website.
              </li>
              <li>
            ...
            <p className="mb-3">
              We attempt to be as accurate as possible when posting content. We
              ...
              solely for general information purposes with no inherent
              warranties implied. Any reliance you place on such information is
            ...
            <li className="text-2xl mb-3 mt-10">Product Pricing</li>
            ...
            <li className="text-2xl mb-3 mt-10">Links from the Website</li>
            <p className="mb-3">
